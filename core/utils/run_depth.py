...
if __name__ == "__main__":
    ...
    CUDA_VISIBLE_DEVICES=3 python core/utils/run_depth.py \
        --img_dir current-data-dir/bedkids/rgb \
        --out_raw_dir current-data-dir/bedkids/depth_anything_v2 \
        --out_aligned_dir current-data-dir/bedkids/aligned_depth_anything_v2 \
    """
    main()
